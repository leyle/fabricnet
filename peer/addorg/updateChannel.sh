...
peer channel update -f ${UPDATE_PB} -c $CHANNEL_NAME -o ${ORDERER_HOSTPORT} --ordererTLSHostnameOverride $ORDERER_HOST --tls --cafile $TLS_CA_FILE
echo "update configtx done, updated by: $ORG_MSPID"
