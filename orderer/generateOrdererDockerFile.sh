...
do
    ...
    CUR_OPERATION_PORT=$((ORDERER_OPERATION_PORT + PORT_BASE))
    ...
    echo "export ORDERER_PORT=$CUR_ORDERER_PORT" >> $PEER_ENV_FILE
    echo "export ORDERER_OSN_PORT=$CUR_ORDERER_OSN_PORT" >> $PEER_ENV_FILE
    echo "export ORDERER_OPERATION_PORT=$CUR_OPERATION_PORT" >> $PEER_ENV_FILE
